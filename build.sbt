...
libraryDependencies ++= {
  	Seq(
		...
		"com.databricks" % "spark-redshift_2.11" % "2.0.0",
		"org.apache.commons" % "commons-lang3" % "3.3.2",
		"com.amazonaws" % "aws-java-sdk-s3" % "1.11.79",
		"com.amazonaws" % "aws-java-sdk-redshift" % "1.11.79",
		//"com.amazon" % "redshift.jdbc41" % "1.1.13.1013",
